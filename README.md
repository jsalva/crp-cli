...
To get an invite all you have to do is ask [@CrowdProcess](http://twitter.com/CrowdProcess) on twitter or send us an <a href="mailto:hello@crowdprocess.com&subject=Gimme an invite code&body=Hi,&body=My name is&body=I want to use CrowdProcess to" target="_blank">e-mail</a>
